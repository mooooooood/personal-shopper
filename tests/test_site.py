...
class SiteTests(unittest.TestCase):
    ...
    def test_meadow_assets_and_accessible_controls(self):
        ...
        for asset, media_type in [('meadow.css', 'text/css'), ('meadow.js', 'javascript'), ('meadow-model.js', 'javascript'), ('meadow-surprises.js', 'javascript'), ('meadow-timing.js', 'javascript')]:
